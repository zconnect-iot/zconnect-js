...
export const BATCH_REQUEST_SUCCESS = 'core/api/BATCH_REQUEST_SUCCESS'
export const BATCH_REQUEST_FAILED = 'core/api/BATCH_REQUEST_FAILED'
...
export const REQUEST_RESET = 'core/api/REQUEST_RESET'
export const SET_POLL_INTERVAL = 'core/api/SET_POLL_INTERVAL'
