...
var FETCH_TIMEOUT = exports.FETCH_TIMEOUT = 10000;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sagaHelpers__ = __webpack_require__(23);
...
exports.refreshJWT = exports.resetPasswordError = exports.resetPasswordSuccess = exports.resetPassword = exports.registerUserError = exports.registerUserSuccess = exports.registerUser = exports.setUserGroups = exports.loginFailure = exports.resetAuthApi = exports.logout = exports.loginUserState = exports.requestLogin = undefined;
...
* JWT refresh
*/
var refreshJWT = exports.refreshJWT = function refreshJWT() {
  return { type: _constants.REFRESH_JWT };
};
...
var selectRequestPollingInterval = exports.selectRequestPollingInterval = (0, _reselect.createSelector)(selectRequestDomain, function (request) {
  return request.get('polling', false);
});
...
var selectRequestAPIState = exports.selectRequestAPIState = (0, _reselect.createSelector)(selectRequestFailed, selectRequestFetched, selectRequestPending, function (error, success, fetching) {
  return { error: error, success: success, fetching: fetching };
});
...
var _eJSON = __webpack_require__(18);
...
exports.configureZC = configureZC;
...
function configureZC(appDependencies) {
...
function configureApiSagas(_ref, refreshJWT) {
  ...
  var _marked = [fetchSaga, secureFetch, secureApiSaga, insecureFetch, processParams, processPayload, apiRequest, apiPoll, watcher].map(regeneratorRuntime.mark);
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _effects.race)({
              response: _effects.call.apply(undefined, [_utils.apifetch, baseURL].concat(args)),
              timeout: (0, _effects.call)(_reduxSaga.delay, _constants.FETCH_TIMEOUT)
            });
  ...
  function secureFetch() {
    ...
    var token;
    return regeneratorRuntime.wrap(function secureFetch$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            _context2.next = 5;
            return _effects.call.apply(undefined, [fetchSaga].concat(args, [token.password]));
  ...
  function secureApiSaga() {
    ...
    var token, status;
    return regeneratorRuntime.wrap(function secureApiSaga$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            _context3.next = 7;
            return _effects.call.apply(undefined, [secureFetch].concat(args));
          ...
          case 10:
            ...
            status = _context3.t0.response && _context3.t0.response.status;
  ...
  function insecureFetch() {
    ...
    return regeneratorRuntime.wrap(function insecureFetch$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return _effects.call.apply(undefined, [fetchSaga].concat(args));
  ...
  function processParams() {
    ...
    var selectors, p, i;
    return regeneratorRuntime.wrap(function processParams$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 6:
            p[selectors[i][0]] = _context5.sent;
  ...
  function processPayload() {
    ...
    var selectors, p, i;
    return regeneratorRuntime.wrap(function processPayload$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            // TODO: Allow processing of nested selectors (currently only handles selectors at top level)
            selectors = Object.entries(payload).filter(function (entry) {
          ...
          case 6:
            p[selectors[i][0]] = _context6.sent;
  ...
  function apiRequest(action) {
    var meta, type, endpoint, config, params, payload, cacheAge, url, response;
    return regeneratorRuntime.wrap(function apiRequest$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 5:
            ...
            _context7.next = 8;
            return (0, _effects.call)(processPayload, action.payload);
          ...
          case 24:
            _context7.prev = 24;
            _context7.next = 27;
            return (0, _effects.call)(config.token ? secureApiSaga : insecureFetch, url, config.method, payload);
          ...
          case 33:
            ...
            _context7.next = 37;
            return (0, _effects.put)((0, _actions.requestFailed)(endpoint, params, _context7.t0));
    ...
    }, _marked[6], this, [[24, 33]]);
  }

  function apiPoll(action) {
    var _action$meta, endpoint, params, interval;

    return regeneratorRuntime.wrap(function apiPoll$(_context8) {
      while (1) {
  ...
  function watcher() {
    return regeneratorRuntime.wrap(function watcher$(_context9) {
      while (1) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__takeEvery__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__takeLatest__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__throttle__ = __webpack_require__(27);
...
exports.selectUserSettings = exports.selectUserLoggedIn = exports.selectErrorStatus = exports.selectErrorJsonDescription = exports.selectErrorJsonTitle = exports.selectErrorDescription = exports.selectErrorTitle = exports.selectError = exports.selectResetPasswordAPIState = exports.selectRegistrationAPIState = exports.selectAuthAPIState = exports.selectUserIsPremium = exports.selectUserGroups = exports.selectEmail = exports.selectUserId = exports.selectAuthDomain = undefined;
...
var selectError = exports.selectError = (0, _reselect.createSelector)(selectAuthDomain, function (substate) {
  return substate.get('error', (0, _immutable.Map)());
});

var selectErrorTitle = exports.selectErrorTitle = (0, _reselect.createSelector)(selectError, function (error) {
  return error.get('title');
});

var selectErrorDescription = exports.selectErrorDescription = (0, _reselect.createSelector)(selectError, function (error) {
