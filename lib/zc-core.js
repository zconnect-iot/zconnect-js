...
function configureApiSagas(_ref, refreshJWT) {
  ...
  function apiRequest(_ref2) {
    ...
    var endpoint, config, params, cacheAge, url, response;
...
function configureAuthSagas(_ref) {
  ...
  */
  ...
  function loginSaga(action) {
    var url, method, email, password, body, _ref3, response, timeout, JWTokenDecoded, userID, userGroups, processedError;
