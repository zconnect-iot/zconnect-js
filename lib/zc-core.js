...
function apifetch(baseURL, url) {
  ...
  var token = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : undefined;
  var resetToken = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;

  var fullUrl = '' + baseURL + url;
  var headers = getHeaders(method, token, resetToken);
  var details = {
    method: method,
    headers: headers,
    mode: 'cors',
...
var _selectors2 = __webpack_require__(37);
...
function config(_ref) {
  var Sentry = _ref.Sentry,
      ...
      processError = _ref.processError,
      endpoints = _ref.endpoints;

  exports.authSagas = authSagas = (0, _sagas4.default)(Sentry, jwtStore, baseURL, loginTimeout, processError);
  exports.apiSagas = apiSagas = (0, _sagas2.default)(Sentry, jwtStore, baseURL, endpoints, authSagas.refreshJWT);
}
...
exports.default = configureSagas;
...
function configureSagas(Sentry, jwtStore, baseURL, endpoints, refreshJWT) {
  var _marked = [secureApiSaga, secureApiSagaNoLogout, processParams, apiRequest, apiPoll, watcher].map(regeneratorRuntime.mark);
  ...
  function secureApiSaga() {
    ...
    return regeneratorRuntime.wrap(function secureApiSaga$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            token = _context.sent;
            _context.next = 7;
            return _utils.apifetch.apply(undefined, [baseURL].concat(args, [token = token.password]));
          ...
          case 11:
            ...
            if (!(!token || _context.t0.response.status === 401 || _context.t0.response.status === 403)) {
              _context.next = 30;
              break;
            }

            _context.prev = 14;
            return _context.delegateYield((0, _effects.call)(refreshJWT), 't1', 16);
          ...
          case 18:
            token = _context.sent;
            _context.next = 21;
            return _utils.apifetch.apply(undefined, [baseURL].concat(args, [token.password]));
  ...
  function secureApiSagaNoLogout() {
    ...
    var token, response;
    return regeneratorRuntime.wrap(function secureApiSagaNoLogout$(_context2) {
      while (1) {
  ...
  function processParams() {
    ...
    var selectors, p, i;
    return regeneratorRuntime.wrap(function processParams$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            p[selectors[i][0]] = _context3.sent;
  ...
  function apiRequest(_ref) {
    ...
    var endpoint, config, params, cacheAge, url, response, error;
    return regeneratorRuntime.wrap(function apiRequest$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 14:
            url = formatUrl(config.url, params);
            _context4.next = 17;
          ...
          case 17:
            ...
            _context4.prev = 19;
            _context4.next = 22;
            return (0, _effects.call)(secureApiSaga, url, config.method, payload);
          ...
          case 27:
            ...
            error = _context4.t0;
            _context4.next = 32;
            return (0, _effects.put)((0, _actions.requestFailed)(endpoint, params, _context4.t0));
    ...
    }, _marked[3], this, [[19, 27]]);
  }

  function apiPoll(action) {
    var _action$meta, endpoint, params, interval;

    return regeneratorRuntime.wrap(function apiPoll$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            if (!(action.type === _constants.STOP_POLL_REQUEST)) {
              _context5.next = 2;
              break;
            }
          ...
          case 2:
            ...
            interval = (0, _effects.select)(_selectors.selectRequestPollingInterval, { endpoint: endpoint, params: params });
          ...
          case 4:
            ...
            _context5.prev = 5;
            _context5.next = 8;
            return (0, _effects.call)(apiRequest().worker, action);
    ...
    return regeneratorRuntime.wrap(function watcher$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return [(0, _reduxSaga.takeEvery)([_constants.POLL_REQUEST, _constants.STOP_POLL_REQUEST], apiPoll), (0, _reduxSaga.takeEvery)(_constants.REQUEST, apiRequest)];
...
exports.selectUserSettings = exports.selectUserLoggedIn = exports.selectErrorDetails = exports.selectResetPasswordAPIState = exports.selectRegistrationAPIState = exports.selectAuthAPIState = exports.selectUserIsPremium = exports.selectUserGroups = exports.selectEmail = exports.selectUserId = exports.selectAuthDomain = undefined;
...
var selectErrorDetails = exports.selectErrorDetails = (0, _reselect.createSelector)(selectAuthDomain, function (substate) {
  return substate.get('error').toJS();
});
...
function authReducer() {
  ...
  switch (action.type) {
    ...
    case _constants.LOGIN_FAILURE:
      return state.set('authAPIState', (0, _immutable.fromJS)(apiState.error)).set('error', (0, _immutable.fromJS)(action.error));
    ...
    case _constants.REGISTER_USER_ERROR:
      return state.set('registrationAPIState', (0, _immutable.fromJS)(apiState.error)).set('error', (0, _immutable.fromJS)(action.error));
    ...
    case _constants.RESET_PASSWORD_ERROR:
      return state.set('resetPasswordAPIState', (0, _immutable.fromJS)(apiState.error)).set('error', (0, _immutable.fromJS)(action.error));
...
function configureAuthSagas(Sentry, jwtStore, baseURL, loginTimeout, processError) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            _context.next = 9;
            return (0, _effects.call)(processError, _context.t0);
  ...
  */
  function refreshJWT() {
    var url, _ref, response, timeout, oldToken, email, JWTokenDecoded, userGroups, userID;
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _effects.race)({
              response: (0, _effects.call)(_utils.secureApiSagaNoLogout, url, 'GET', {}),
          ...
          case 23:
            ...
            _context2.next = 27;
            return (0, _effects.call)(processError, _context2.t0);
  ...
  function loginSaga(action) {
    var url, method, email, password, body, result, processedError, _result, response, JWTokenDecoded, userID, userGroups;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 14:
            ...
            _context3.next = 18;
            return (0, _effects.call)(processError, _context3.t0);

          case 18:
            processedError = _context3.sent;
            _context3.next = 21;
            return (0, _effects.put)(actions.loginFailure(processedError));
  ...
  function registerUserSaga(action) {
    var url, method, email, password, fname, lname, user_type, body, processedError;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 15:
            ...
            _context4.next = 19;
            return (0, _effects.call)(processError, _context4.t0);

          case 19:
            processedError = _context4.sent;
            _context4.next = 22;
            return (0, _effects.put)(actions.registerUserError(processedError));
  ...
  function resetPasswordSaga(action) {
    var url, method, email, body, processedError;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 11:
            ...
            _context5.next = 15;
            return (0, _effects.call)(processError, _context5.t0);

          case 15:
            processedError = _context5.sent;
            _context5.next = 18;
            return (0, _effects.put)(actions.resetPasswordError(processedError));
